...
//           if (
//             item._id.toString() == updatedCartItems[index].productId.toString()
//           ) {
//             for (let i = 0; i < newCouple.length; i++) {
//               if (
//                 newCouple[i].productId.toString() ==
//                 updatedCartItems[index].productId.toString()
//               ) {
//                 updatedCartItems[index].quantity = newCouple[i].newQuantity;
//                 newSum =
//                   newSum +
//                   parseFloat(item.price) * parseFloat(newCouple[i].newQuantity);
//                 console.log(
//                   "BenTrong: userSchema.methods.updateCart -> newSum",
//                   newSum
//                 );
//               }
//             }
...
//     console.log(
//       "​userSchema.methods.addToComment -> this.commentBox.items[userCommentList].commentlist",
//       this.commentBox.items[userCommentList].commentlist
//     );
